...
- Google Professional Certificates: IT Automation with Python (6 courses: `Crash Course on Python`, `Using Python to Interact with the Operating System`, `Git and GitHub`, `Troubleshooting and Debugging Techniques`, `Configuration Management and the Cloud` and `Automating Real-World Tasks with Python`) and IT support (5 courses: `Technical assitance`, `Bits and bytes of Network`, `Operating system: advanced user`, `System Admin and infrastructure services of IT`, `Cybersecurity: Defense against the digital dark arts`).
